...
For example, the array of mineral composition strings
. The minerals and appear in each composite, so there are
...
where each letter represents an occurence of a mineral in the current rock.
...
consists of only lower-case Latin letters ('a'-'z').
