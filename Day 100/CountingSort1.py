...
. All of the values are in the range , so create an array of zeroes,
...
Output the number of times every number from
through appears in

as a list of space-separated integers on one line.
