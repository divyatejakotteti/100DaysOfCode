...
lines (rows) contains positive digits without spaces (columns) representing depth at
...
lines, denoting the resulting map. Each cavity should be replaced with the character X.
